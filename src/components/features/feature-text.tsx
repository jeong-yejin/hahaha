  ...
  return (
    <div className="flex flex-col justify-center">
      ...
      >
        ...
        <span className="relative flex h-7 w-7 items-center justify-center rounded-full bg-[#CAFF5D]/[0.12] ring-1 ring-inset ring-[#CAFF5D]/30 transition-[background-color,box-shadow] duration-500 ease-[cubic-bezier(0.32,0.72,0,1)] group-hover:bg-[#CAFF5D]/20 group-hover:ring-[#CAFF5D]/55">
